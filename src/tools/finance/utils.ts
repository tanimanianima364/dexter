 ...
 * Sized for cursor pagination: a year of daily prices arrives as ~25
 * sequential pages, which routinely exceeds the old 15s budget. */
export const SUB_TOOL_TIMEOUT_MS = 60_000;
